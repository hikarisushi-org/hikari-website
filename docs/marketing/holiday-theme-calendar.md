# Hikari Website Holiday Theme Calendar

This document defines the approved holidays and themed events that will be used for website visual swaps, promotional campaigns, and seasonal branding updates. It serves as the official source of truth for planning and scheduling all holiday-related changes to the Hikari Sushi website.

...
const menuData = {
  'most-ordered': {
    title: 'Most Popular',
    items: [
      { name: 'Firefly Fusion', price: '$14.50', desc: 'Tempura shrimp, cilantro, and jalapeño. Crowned with spicy crab, tuna, lime slices, eel sauce, mango sauce, cilantro, and tobiko.', img: 'assets/images/menu/sushi/firefly_fussion_2.png' },
      { name: 'Citrus Mango Dream', price: '$14', desc: 'Tempura shrimp, cream cheese, and crab mix. Crowned with fresh mango and lemon slices. Finished with mango sauce.', img: 'assets/images/menu/sushi/citrus_mango_dream.png' },
      { name: 'Hot Cheetos Roll', price: '$12', desc: 'Spicy crab, cream cheese, and cucumber. Topped with crushed Hot Cheetos. Finished with spicy mayo and eel sauce.', img: 'assets/images/menu/sushi/hot_cheetos.png' },
      { name: 'Strawberry Blossom', price: '$14', desc: 'Kani crab sticks, cream cheese, and cucumber. Topped with fresh salmon, strawberries, mango sauce, tempura crunchies, and sesame seeds.', img: 'assets/images/menu/sushi/strawberry_blossom.png' },
      { name: 'Avocado King', price: '$12', desc: 'Shrimp tempura, cucumbers, and radish sprouts. Topped with a generous layer of avocado, eel sauce, and crunchies.', img: 'assets/images/menu/sushi/avocado_king.png' },
  ...
  'appetizers': {
    ...
    items: [
      ...
      { name: 'Jalapeño Bomb (4 pcs)', price: '$8', desc: 'Tempura-battered jalapeño stuffed with spicy tuna and cream cheese. Topped with spicy aioli, eel sauce, green onion, and tobiko.', img: 'assets/images/menu/appetizers/jalapeno_bomb.png', raw: true },
  ...
  'traditional-rolls': {
    ...
    items: [
      { name: 'Alaskan Roll', price: '$8', desc: 'Salmon, avocado, and pickled radish. Topped with sesame seeds.', raw: true },
      { name: 'Classic California Roll', price: '$8', desc: 'Crab mix, avocado, and cucumber. Topped with sesame seeds.', img: 'assets/images/menu/sushi/california_roll.png' },
      { name: 'Philly Roll', price: '$8', desc: 'Salmon, avocado, and cream cheese. Topped with sesame seeds.', img: 'assets/images/menu/sushi/philly.png', raw: true },
      { name: 'Shrimp Tempura Roll', price: '$8', desc: 'Tempura shrimp, avocado, cucumber, and radish sprouts. Topped with sesame seeds.', img: 'assets/images/menu/sushi/tempura_shrimp_roll.png' },
      { name: 'Spicy Hamachi Roll', price: '$8', desc: 'Hamachi, sriracha, avocado, cucumber, and radish sprouts. Topped with green onions.', img: 'assets/images/menu/sushi/spicy_hamachi.jpg', raw: true },
      { name: 'Spicy Salmon Roll', price: '$9', desc: 'Spicy salmon mix, avocado, cucumber, and radish sprouts. Topped with tempura crunch and sesame seeds.', img: 'assets/images/menu/sushi/spicy_salmon.jpg', raw: true },
      { name: 'Spicy Tuna Roll', price: '$9', desc: 'Spicy tuna mix, cucumber, and radish sprouts. Topped with spicy mayo.', img: 'assets/images/menu/sushi/spicy_tuna_roll.jpg', raw: true },
      { name: 'Sweet Potato Roll', price: '$7.50', desc: 'Tempura sweet potato. Finished with eel sauce and sesame seeds.', img: 'assets/images/menu/sushi/sweet_potato_roll.png' },
      { name: 'Unagi Maki Roll', price: '$9', desc: 'Broiled eel, avocado, and cucumber. Finished with eel sauce and sesame seeds.' },
      { name: 'Veggie Roll', price: '$7.50', desc: 'Avocado, cucumber, asparagus, and red bell pepper. Topped with sesame seeds.', img: 'assets/images/menu/sushi/veggie_roll.png' },
      { name: 'Yaki Maguro', price: '$14', desc: '', img: 'assets/images/menu/sushi/yaki_maguro.png', raw: true },
    ]
  },
  'premium-rolls': {
    title: 'Premium Rolls',
    items: [
      { name: 'Citrus Mango Dream', price: '$14', desc: 'Tempura shrimp, cream cheese, and crab mix. Crowned with fresh mango and lemon slices. Finished with mango sauce.', img: 'assets/images/menu/sushi/citrus_mango_dream.png' },
      { name: 'Emerald Dragon Roll', price: '$14', desc: 'Tempura shrimp, cucumber, and crab mix. Crowned with eel and avocado. Finished with wasabi mayo and eel sauce.', img: 'assets/images/menu/sushi/emerald_dragon.png' },
      { name: 'Hikari Delight Roll', price: '$14.50', desc: 'Salmon, mango, spicy mayo, and jalapeño. Crowned with hamachi, lime slices, green onions, and tempura crunch. Finished with ponzu sauce.', img: 'assets/images/menu/sushi/hikari_delight.png', raw: true },
      { name: 'Salmon Sunrise Roll', price: '$13', desc: 'Grilled asparagus, crab mix, and avocado. Crowned with salmon and lemon slices. Finished with ponzu sauce.', img: 'assets/images/menu/sushi/salmon_sunrise.png', raw: true },
      { name: 'Solar Flare Roll', price: '$14.50', desc: 'Spicy salmon, jalapeño, and cucumber. Crowned with hamachi, ebi, and green onions. Finished with house macho sauce.', img: 'assets/images/menu/sushi/solar_flare.png', raw: true },
      { name: 'Hot Cheetos Roll', price: '$12', desc: 'Spicy crab, cream cheese, and cucumber. Topped with crushed Hot Cheetos. Finished with spicy mayo and eel sauce.', img: 'assets/images/menu/sushi/hot_cheetos.png' },
      { name: 'Playboy', price: '$12', desc: 'Shrimp tempura, crab mix, and cream cheese. Topped with tuna, avocado, spicy mayo, eel sauce, sesame seeds and tobiko.', img: 'assets/images/menu/sushi/playboy.png', raw: true },
      { name: 'Lava Volcano Roll', price: '$12', desc: 'Eel, crab mix, and avocado. Baked with spicy mayo. Finished with eel sauce, green onions, and tobiko.', raw: true },
      { name: 'Illuminated Fire Tuna', price: '$14', desc: 'Mango, tuna, and jalapeño. Crowned with spicy tuna, lime slices, Thai chiles, and green onions. Finished with garlic ponzu.', img: 'assets/images/menu/sushi/illuminated_fire_tuna.png', raw: true },
      { name: 'Mt Fuji Roll', price: '$14.50', desc: 'Albacore, avocado, and cucumber. Crowned with ebi, crab mix, green onions, and crunch flakes. Finished with eel sauce.', img: 'assets/images/menu/sushi/mt_fuji.png', raw: true },
      { name: 'Strawberry Blossom', price: '$14', desc: 'Kani crab sticks, cream cheese, and cucumber. Topped with fresh salmon, strawberries, mango sauce, tempura crunchies, and sesame seeds.', img: 'assets/images/menu/sushi/strawberry_blossom.png' },
      ...
      { name: 'The Forbidden Roll', price: '$13.50', desc: 'Apple, crab mix, and red bell peppers inside. Topped with cream cheese, fried banana, eel sauce, lemon zest, and crunchies.', img: 'assets/images/menu/sushi/forbidden_roll.png' },
      { name: 'Firefly Fusion', price: '$14.50', desc: 'Tempura shrimp, cilantro, and jalapeño. Crowned with spicy crab, tuna, lime slices, eel sauce, mango sauce, cilantro, and tobiko.', img: 'assets/images/menu/sushi/firefly_fussion_2.png' },
      { name: 'Red Lantern', price: '$13.50', desc: 'Seaweed salad, red bell peppers, and shrimp tempura inside. Topped with tuna, eel sauce, spicy mayo, sriracha, and crunchies.', img: 'assets/images/menu/sushi/red_lantern.png' },
      { name: 'Avocado King', price: '$12', desc: 'Shrimp tempura, cucumbers, and radish sprouts. Topped with a generous layer of avocado, eel sauce, and crunchies.', img: 'assets/images/menu/sushi/avocado_king.png' },
      { name: 'Cowboy Roll', price: '$15', desc: 'Asparagus and crab mix inside, topped with Wagyu beef, spicy eel sauce, green onions, and sesame seeds.', img: 'assets/images/menu/sushi/cowboy_roll.png' },
      { name: 'Yaki Maguro Roll', price: '$14', desc: '', img: 'assets/images/menu/sushi/yaki_maguro.png', raw: true },
    ]
  },
  'heroes': {
    title: 'Heroes',
  ...
  'tempura-fried': {
    title: 'Tempura Fried',
    items: [
      { name: 'Cali Mex Roll', price: '$10', desc: 'A twist on the California roll. Topped with eel sauce, spicy mayo, cilantro, and tobiko.', img: 'assets/images/menu/sushi/calimex.png', raw: true },
      { name: 'Fire Spicy Tuna Roll', price: '$10', desc: 'Spicy tuna mix, cucumber, and jalapeño. Topped with eel sauce, green onions, and sesame seeds.', img: 'assets/images/menu/sushi/fire_spicy_tuna.png', raw: true },
      { name: 'Las Vegas Roll', price: '$12', desc: 'Salmon, cream cheese, and crab mix. Topped with eel sauce and spicy mayo.', img: 'assets/images/menu/sushi/las_vegas.png', raw: true },
      { name: 'Monument Roll', price: '$10', desc: 'Hamachi, salmon, tuna, ebi, and avocado. Crowned with spicy eel sauce, green onions, and sesame seeds.', img: 'assets/images/menu/sushi/monument.png', raw: true },
    ]
  },
  'maki': {
    title: 'Maki',
